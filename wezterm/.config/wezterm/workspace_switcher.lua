-- taken from https://github.com/MLFlexer/smart_workspace_switcher.wezterm/blob/main/plugin/init.lua under the MIT license. Copyright (c) 2023 Malthe Larsen.
