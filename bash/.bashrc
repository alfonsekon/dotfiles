...
# brightness controls
alias b0='brightnessctl set 1%'
alias b1='brightnessctl set 10%'
alias b2='brightnessctl set 20%'
alias b3='brightnessctl set 30%'
alias b4='brightnessctl set 40%'
alias b5='brightnessctl set 50%'
alias b6='brightnessctl set 60%'
alias b7='brightnessctl set 70%'
alias b8='brightnessctl set 80%'
alias b9='brightnessctl set 90%'
alias b10='brightnessctl set 100%'
alias bup='brightnessctl set +1920'
alias bdown='brightnessctl set 1920-'
